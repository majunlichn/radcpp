    ...
    rad::Ref<Renderer> renderer, SDL_PixelFormat format, SDL_TextureAccess access, int w, int h)
{
    ...
    {
        SDF_LOG(err, "SDL_CreateTexture failed: {}", SDL_GetError());
        return nullptr;
    }
}
    ...
    m_handle(handle)
{
    ...
    if (m_propID == 0)
    {
        SDF_LOG(err, "SDL_GetTextureProperties failed: {}", SDL_GetError());
    }
}
...
bool Texture::GetSize(float* w, float* h)
{
    ...
    {
        SDF_LOG(err, "SDL_GetTextureSize failed: {}", SDL_GetError());
        return false;
    }
}
...
bool Texture::SetColorMod(Uint8 r, Uint8 g, Uint8 b)
{
    ...
    {
        SDF_LOG(err, "SDL_SetTextureColorMod failed: {}", SDL_GetError());
        return false;
    }
}
...
bool Texture::SetColorMod(float r, float g, float b)
{
    ...
    {
        SDF_LOG(err, "SDL_SetTextureColorModFloat failed: {}", SDL_GetError());
        return false;
    }
}
...
bool Texture::GetColorMod(Uint8* r, Uint8* g, Uint8* b)
{
    ...
    {
        SDF_LOG(err, "SDL_GetTextureColorMod failed: {}", SDL_GetError());
        return false;
    }
}
...
bool Texture::GetColorMod(float* r, float* g, float* b)
{
    ...
    {
        SDF_LOG(err, "SDL_GetTextureColorModFloat failed: {}", SDL_GetError());
        return false;
    }
}
...
bool Texture::SetAlphaMod(Uint8 alpha)
{
    ...
    {
        SDF_LOG(err, "SDL_SetTextureAlphaMod failed: {}", SDL_GetError());
        return false;
    }
}
...
bool Texture::SetAlphaMod(float alpha)
{
    ...
    {
        SDF_LOG(err, "SDL_SetTextureAlphaModFloat failed: {}", SDL_GetError());
        return false;
    }
}
...
bool Texture::GetAlphaMod(Uint8* alpha)
{
    ...
    {
        SDF_LOG(err, "SDL_GetTextureAlphaMod failed: {}", SDL_GetError());
        return false;
    }
}
...
bool Texture::GetAlphaMod(float* alpha)
{
    ...
    {
        SDF_LOG(err, "SDL_GetTextureAlphaModFloat failed: {}", SDL_GetError());
        return false;
    }
}
...
bool Texture::SetBlendMode(SDL_BlendMode blendMode)
{
    ...
    {
        SDF_LOG(err, "SDL_SetTextureBlendMode failed: {}", SDL_GetError());
        return false;
    }
}
...
bool Texture::GetBlendMode(SDL_BlendMode* blendMode)
{
    ...
    {
        SDF_LOG(err, "SDL_GetTextureBlendMode failed: {}", SDL_GetError());
        return false;
    }
}
...
bool Texture::SetScaleMode(SDL_ScaleMode scaleMode)
{
    ...
    {
        SDF_LOG(err, "SDL_SetTextureScaleMode failed: {}", SDL_GetError());
        return false;
    }
}
...
bool Texture::GetScaleMode(SDL_ScaleMode* scaleMode)
{
    ...
    {
        SDF_LOG(err, "SDL_GetTextureScaleMode failed: {}", SDL_GetError());
        return false;
    }
}
...
bool Texture::Update(const SDL_Rect* rect, const void* pixels, int pitch)
{
    ...
    {
        SDF_LOG(err, "SDL_UpdateTexture failed: {}", SDL_GetError());
        return false;
    }
}
    ...
    const Uint8* Vplane, int Vpitch)
{
    ...
    {
        SDF_LOG(err, "SDL_UpdateYUVTexture failed: {}", SDL_GetError());
        return false;
    }
}
...
bool Texture::UpdateNV(const SDL_Rect* rect, const Uint8* Yplane, int Ypitch, const Uint8* UVplane, int UVpitch)
{
    ...
    {
        SDF_LOG(err, "SDL_UpdateNVTexture failed: {}", SDL_GetError());
        return false;
    }
}
...
bool Texture::Lock(const SDL_Rect* rect, void** pixels, int* pitch)
{
    ...
    {
        SDF_LOG(err, "SDL_LockTexture failed: {}", SDL_GetError());
        return false;
    }
}
...
bool Texture::LockToSurface(const SDL_Rect* rect, SDL_Surface** surface)
{
    ...
    {
        SDF_LOG(err, "SDL_LockTextureToSurface failed: {}", SDL_GetError());
        return false;
    }
}
