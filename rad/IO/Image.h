...
public:
    ...
    // HDR (radiance rgbE format) expects linear float data, since the format is always 32-bit rgb(e) data,
    // alpha (if provided) is discarded, and for monochrome data it is replicated across all three channels.
