...
void VulkanElementWiseShaderParams::SetScalars(DataType dataType, const Scalar& a, const Scalar& b, const Scalar& c, const Scalar& d)
{
    switch (dataType)
    {
    case ML::DataType::Float16:
    case ML::DataType::Float32:
        m_scalars.f32 = glm::f32vec4(
    ...
    case ML::DataType::Complex32:
        m_scalars.c32[0] = static_cast<rad::Complex32>(a);
        m_scalars.c32[1] = static_cast<rad::Complex32>(b);
        m_scalars.c32[2] = static_cast<rad::Complex32>(c);
        m_scalars.c32[3] = static_cast<rad::Complex32>(d);
        return;
    case ML::DataType::Complex64:
        m_scalars.c64[0] = static_cast<rad::Complex64>(a);
        m_scalars.c64[1] = static_cast<rad::Complex64>(b);
        m_scalars.c64[2] = static_cast<rad::Complex64>(c);
        m_scalars.c64[3] = static_cast<rad::Complex64>(d);
        return;
    case ML::DataType::Complex128:
        m_scalars.c128[0] = static_cast<rad::Complex128>(a);
        m_scalars.c128[1] = static_cast<rad::Complex128>(b);
        m_scalars.c128[2] = static_cast<rad::Complex128>(c);
        m_scalars.c128[3] = static_cast<rad::Complex128>(d);
        return;
    }
    RAD_UNREACHABLE();
}
