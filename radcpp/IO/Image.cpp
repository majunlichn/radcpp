...
bool ImageU8::LoadFromFile(std::string_view filename, int channelCount, float gamma, float scale)
{
...
bool ImageFP32::LoadFromFile(std::string_view filename, int channelCount, float gamma, float scale)
{
    assert(m_data == nullptr);
